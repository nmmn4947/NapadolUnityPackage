...
public class ScaleAction : Napadol.Tools.ActionPattern.Action
{
    ...
    {
        subjectTransform.localScale = new Vector3(Mathf.LerpUnclamped(originalScale.x, finalScale.x, easingTimePasses),
                                                  Mathf.LerpUnclamped(originalScale.y, finalScale.y, easingTimePasses), 
	...
	{ 
		if(this.isReversing)
		{
			subjectTransform.localScale = new Vector3(originalScale.x, originalScale.y, originalScale.z);
		}
		else
		{
			subjectTransform.localScale = new Vector3(finalScale.x, finalScale.y, finalScale.z);
